...
public class ArtistAuctionUserWinningBidUi extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button purchaseButtonNotInvalidated = (Button) findViewById(
                R.id.purchase_button_not_invalidated4);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            findViewById(R.id.purchase_button_not_invalidated_description4)
        ...
        btn1.setOnClickListener(new PurchaseButtonClickListener(defaultCipher, DEFAULT_KEY_NAME) {
        });
    ...
    public void onPurchased4(boolean withFingerprint,
                             @Nullable FingerprintManager.CryptoObject cryptoObject) {
        if (withFingerprint) {
            // If the user has authenticated with fingerprint, verify that using cryptography and
            // then show the confirmation message.

            Toast.makeText(ArtistAuctionUserWinningBidUi.this, "거래 완료가 되었습니다", Toast.LENGTH_SHORT).show();
    ...
    private class PurchaseButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            findViewById(R.id.confirmation_message4).setVisibility(View.GONE);
            findViewById(R.id.encrypted_message4).setVisibility(View.GONE);
