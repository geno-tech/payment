...
public class ArtistAuctionCompleteUi extends AppCompatActivity {
    ...
    String auckey, bidprice, userid, title, image, artistID, bidding, buyername, buyerhp, artistname, artisthp;
    long min_bidding;
...
//                            KEY_NAME_NOT_INVALIDATED));
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                contract = "\uF0E1갤러리 옥션 계약서\uF0F1\n" +
                        "\n" +
                        "본 계약은 구매자 "+buyername+"(이하 “갑”이라 칭함)과(와) 판매자 "+artistname+" (이하 “을”이라 칭함) 간의 미술품경매 운영기본과 “경매참가자”의 자격 및 준수 의무를 정하는 것이다.\n" +
                        "\n" +
                        "\n" +
                        "제 1 장  총   칙\n" +
                        "\n" +
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    alert.setMessage(contract).setCancelable(false).setPositiveButton("거부", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            tts.stop();
                        ...
                        public void onShow(DialogInterface dialog) {
                            ...
                            b.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Date dt = new Date();
                                    SimpleDateFormat sdf = new SimpleDateFormat("yyyy년 MM월 dd일");
                                    String test =                     contract = "<갤러리 옥션 계약서>" +
                                            "\n" +
                                            "본 계약은 구매자 "+buyername+"(이하 “갑”이라 칭함)과(와) 판매자 "+artistname+" (이하 “을”이라 칭함) 간의 미술품경매 운영기본과 “경매참가자”의 자격 및 준수 의무를 정하는 것이다.\n" +
                                            "\n" +
                                            "\n" +
